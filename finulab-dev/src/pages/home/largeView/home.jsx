...
import {ChevronLeft, ChevronRight, ArrowDropUp, RadioButtonUnchecked, KeyboardBackspace, Whatshot, ExpandMore, Bookmark, Tsunami, Search, Cottage, AccountBalanceWallet, PersonSharp, AccountBalance, GroupAddSharp, Close, Verified, Newspaper, Apps, BookmarkAddSharp, PostAddSharp, AssuredWorkloadSharp, LogoutSharp, BookmarkAdded, SendSharp, ConnectWithoutContactSharp, Login, BlurOn, CandlestickChart, Explore, Refresh, Person, AutoAwesome} from '@mui/icons-material';

import Stock_Home from './innerPages/stock';
import Crypto_Home from './innerPages/crypto';
import InnerHomePage from './innerPages/home';
import InnerWalletPage from './innerPages/wallet';
import InnerMarketPage from './innerPages/market';
import InnerProfilePage from './innerPages/profile';
import SpecificMarketTV_Home from './innerPages/marketTv';
import generalOpx from '../../../functions/generalFunctions';
import StockMarketDashboard_Home from './innerPages/stockDashboard';
import CreateCommunity from '../../create-community/createCommunity';
import CryptoMarketDashboard_Home from './innerPages/cryptoDashboard';
import InnerCommunityProfilePage from './innerPages/communityProfile';
...
import FinulabSearchPage from './innerPages/search';
import FinulabShort from './innerPages/short';

export default function LargeHomePage(props) {
    ...
    const homeSearchToggle = () => {
        ...
        if(homeSearch) {
            setHomeSearchQuery("");
            setTimeout(() => {
                setHomeSearchDisplay("none");
            }, 250);
        } else {
            setHomeSearchDisplay("solid 1px var(--primary-bg-08)");
        }
    }
    ...
    const [watchlistHeaderWidth, setWatchlistHeaderWidth] = useState(0);
    useLayoutEffect(() => {
        const watchlistResizeUpdater = () => {
            if(watchlistRef.current) {
                const watchlistHeaderWidthFunction = Math.floor(watchlistRef.current.clientWidth);
                setWatchlistHeaderWidth(watchlistHeaderWidthFunction);
            }
        }

        window.addEventListener('resize', watchlistResizeUpdater);
        watchlistResizeUpdater();
        return () => window.removeEventListener('resize', watchlistResizeUpdater);
    }, []);
    ...
    return(
        <div className="large-homePageWrapper">
            <div className="large-homePageContainer fixed">
                <div className="large-homePageMainNavigationOuterWrapper" ref={searchRef}>
                    <div className="large-homePageMainNavigationWrapper" ref={leftBarBodyRef}>
                        ...
                        <div className="large-homePageMainNavigationIconContainer"/>
                        {user ?
                            <button className="large-homePageMainNavigationIconContainerBtn"
                    ...
                    <div className="large-homePageMainNavigationSearchWrapper"
                            style={homeSearch ? {"borderRight": `${homeSearchDisplay}`} : {"width": "0px", "minWidth": "0px", "maxWidth": "0px", "borderRight": `${homeSearchDisplay}`}}
                        >
                        <div className="large-homePageSearchBarContainer"
                                style={{"width": `${homePageSearchWidth}px`, "minWidth": `${homePageSearchWidth}px`, "maxWidth": `${homePageSearchWidth}px`}}
                            >
                            <input type="text" 
                                placeholder="search"
            ...
            <div className="large-homePageContainer scrollable">
                <div className="large-homePageContentHeader">
                    <>
                        {props.page === "search" ?
                                    ...
                                    <>
                                        {props.page === "wallet" ?
                                            <div className="large-homePageNonHomeDescContainer"
                                                ...
                                                {/*
                                                <button className="large-homePageWalletRefreshBtn"
                                                        onClick={() => refreshWallet()}
                                                    >
                                                    Refresh
                                                </button>
                                                                    ...
                                                                    <div className="large-homePageNonHomeDescContainer" 
                                                                        ...
                                                                        <div className="large-homeMarketPageSearchBarContainer"
                                                                            ...
                                                                            {marketData["query"].length > 0 ?
                                                                                <button className="large-homePageSearchBarInputBtn" onClick={() => clearMarketQuery()} style={{"marginLeft": "auto"}}>
                                                                                    <Close className="large-homePageSearchBarWatchlistInputIcon"/>
                                                                                </button> : null
                                                                            }
                                                                        </div>
                ...
                <>
                    {props.page === "search" ?
                        ...
                        <>
                            {props.page === "home" ?
                                <InnerHomePage displayView={props.displayView} postId={props.postId} newsId={props.newsId} /> : 
                                <>
                                    {props.page === "wallet" ?
                                        <InnerWalletPage displayView={props.displayView} /> :
                                        <>
                                            {props.page === "market" ?
                                                <>
                                                    {props.marketId === null || props.marketId === undefined || props.marketId === "" ?
                                                        <InnerMarketPage displayView={props.displayView} marketType={props.marketType} predictionId={props.predictionId} /> : 
                                                        <SpecificMarketTV_Home displayView={props.displayView} marketId={props.marketId} selection={props.selection} />
                                                    }
                                                </> : 
                                                <>
                                                    {props.page === "profile" ?
                                                        <>
                                                            {props.userId.slice(0, 3) === "f:-" ?
                                                                <InnerCommunityProfilePage userId={props.userId} displayView={props.displayView}/> :
                                                                <InnerProfilePage userId={props.userId} displayView={props.displayView}/>
                                                            }
                                                        </> : 
                                                        <>
                                                            {props.page === "stocks" ?
                                                                <>
                                                                    {props.ticker === null || props.ticker === undefined || props.ticker === "" ?
                                                                        <StockMarketDashboard_Home /> : <Stock_Home displayView={props.displayView} ticker={props.ticker}/>
                                                                    }
                                                                </> : 
                                                                <>
                                                                    {props.page === "cryptos" ?
                                                                        <>
                                                                            {props.ticker === null || props.ticker === undefined || props.ticker === "" ?
                                                                                <CryptoMarketDashboard_Home /> : <Crypto_Home displayView={props.displayView} ticker={props.ticker} />
                                                                            }
                                                                        </> : 
                                                                        <>
                                                                            {props.page === "create-post" ?
            ...
            <div className="large-homePageContainer fixed" style={{"borderLeft": "solid 1px var(--primary-bg-08)"}}>
