...
import {ChevronLeft, ChevronRight, ArrowDropUp, RadioButtonUnchecked, KeyboardBackspace, Whatshot, ExpandMore, Bookmark, Search, Cottage, AccountBalanceWallet, PersonSharp, AccountBalance, GroupAddSharp, Close, Verified, Newspaper, Apps, BookmarkAddSharp, PostAddSharp, AssuredWorkloadSharp, LogoutSharp, BookmarkAdded, SendSharp, ConnectWithoutContactSharp, Login, Send, Public, Notifications, BlurOn, CandlestickChart, ReadMore, Person, SearchSharp, DeveloperMode, Refresh, CurrencyExchange, AutoAwesome} from '@mui/icons-material';
...
export default function SmallHomePage(props) {
                    ...
                    if(!sb_overlayContainerRef.current?.contains(event?.target) && !sb_overlayRef.current?.contains(event?.target)) {
                        setTimeout(() => {
                            ...
                            setTimeout(() => {
                                ...
                                setTimeout(() => {setSm_viewLeftbarWidth(0);}, 5);
                            }, 0);
                        }, 0);
                    }
                }
    ...
    return(
        <div className="small-homePageWrapper">
            ...
            <div className="small-homePageLeftSideWrapper"
                ...
                {user ?
                        ...
                        <div className="small-homePageLeftSideInnerWrapper">
                            ...
                            <div className="large-homePageRighBarCreateOptnsContainer">
                                ...
                                <button className="large-homePageRightBarCreateBtn"
                                    ...
                                    >
                                    <GroupAddSharp className="large-homePageRightBarCreateBtnIcon" style={{"marginLeft": "-5px"}}/>
                                    Group
                                </button>
                                {user.verified ?
                                    <button className="large-homePageRightBarCreateBtn"
                    ...
                    <>
                        ...
                        <div className="small-leftBarPaddingBottom" style={{"height": "86px", "minHeight": "86px", "maxHeight": "86px"}}/>
                    </>
                }
            </div>
            <div className="small-homePageContainer"
                ...
                />
                <div className="small-homePageContentHeader"
                        style={homeSearch || props.page !== "home" ? 
                            {"height": "50px", "minHeight": "50px", "maxHeight": "50px", "borderBottom": "solid 1px var(--primary-bg-08)"} :
                            (props.postId !== "" || props.newsId !== "") ? 
                            {"height": "50px", "minHeight": "50px", "maxHeight": "50px", "borderBottom": "solid 1px var(--primary-bg-08)"} :
                            v_display ?
                            {
                                "height": !homeSearch && props.page === "home" && (props.displayView === undefined || props.displayView === null 
                                    || props.displayView === "" || props.displayView === "following") ? "100px" : "50px", 
                                "minHeight": !homeSearch && props.page === "home" && (props.displayView === undefined || props.displayView === null 
                                    || props.displayView === "" || props.displayView === "following") ? "100px" : "50px", 
                                "maxHeight": !homeSearch && props.page === "home" && (props.displayView === undefined || props.displayView === null 
                                    || props.displayView === "" || props.displayView === "following") ? "100px" : "50px"
                    ...
                    <div className="small-homePageContentHeaderTop"
                            style={!homeSearch && props.page === "home" && (props.displayView === undefined || props.displayView === null 
                                ...
                                {props.page === "home" ?
                                    <>
                                        {props.displayView === undefined || props.displayView === null 
                                            || props.displayView === "" || props.displayView === "following" ?
                                            <>
                                                <button className="large-homePageContentHeaderSmallBtn"
                                                        onClick={() => navigate(`/`)}
                ...
                {homeSearch ?
                    <>
                        {homeSearchQuery === "" && usersQuery.length + communitiesQuery.length + stocksQuery.length + cryptosQuery.length === 0 ?
                            <div className="sm-searchPageNoResult">
                                <div className="large-homePageContentBodyMargin" />
                                <DeveloperMode className="sm-searchPageNoResultIcon"/>
                                <div className="prediction-noTradingStatusInfoTopLine" style={{"marginTop": "125px"}}>
                                    World at your finger tips.
                                </div>
                                <div className="prediction-noTradingStatusInfoSecondLine" style={{"fontSize": "1rem"}}>
                                    Search users, communities, stocks, & cryptos.
                                </div>
                            </div> :
                                                                ...
                                                                {props.page === "stocks" ?
                                                                    ...
                                                                    <>
                                                                        {props.page === "cryptos" ?
                                                                            ...
                                                                            <>
                                                                                {props.page === "create-post" ?
                                                                                    <FinulabCreatePost f_viewPort={"small"}/> : 
                                                                                    <>
                                                                                        {props.page === "create-community" ?
                                                                                            <CreateCommunity f_viewPort={"small"}/> : 
                                                                                            <>
                                                                                                {props.page === "create-prediction" ?
                                                                                                    <FinulabCreatePrediction f_viewPort={"small"}/> : null
                                                                                                }
                                                                                            </>
                                                                                        }
                                                                                    </>
                ...
                {user ? 
                    <>
                        {!homeSearch && ((props.page === "profile" && props.displayView === "") || (props.page === "home" && props.postId === "" && props.newsId === "")) ? 
                            <div className="large-secondaryhomePageContentCreateWrapper"
                                    style={
                                        {
                                            ...{"right": `${sm_viewLeftbarWidth === 0 && sm_viewRightbarWidth === 0 ?
                                                    5 : sm_viewLeftbarWidth === 300 ? sm_viewLeftbarWidth : sm_viewRightbarWidth === 300 ? -sm_viewRightbarWidth : 5
                                                }px`
                                            },
                                            ...{
                            ...
                            <>
                                {user.verified && !homeSearch && ((props.page === "profile" && props.displayView === "markets") || props.page === "market") && props.marketId === "" && props.predictionId === "" ? 
                                    <div className="large-secondaryhomePageContentCreateWrapper"
                                            style={
                                                {
                                                    ...{"right": `${sm_viewLeftbarWidth === 0 && sm_viewRightbarWidth === 0 ?
                                                            "0" : sm_viewLeftbarWidth === 300 ? `${sm_viewLeftbarWidth}px` : sm_viewRightbarWidth === 300 ? `${-sm_viewRightbarWidth}px` : 0
                                                        }px`
                                                    },
                                                    ...{
                                                        "opacity": v_display ? "1" : "0",
                        ...
                        style={
                            {
                                ...
                                ...{
                                    "height": v_display ? "75px" : "0px",
                                    "minHeight": v_display ? "75px" : "0px",
                                    "maxHeight": v_display ? "75px" : "0px"
                                }
                            }
                        }
                    >
                    <div className="large-homePageContentCreateSecondaryWrapper">
                        {user ? 
                            <button className="large-homePageMainNavigationIconContainerBtn"
                                    onClick={() => {setHomeSearch(false); setHomeSearchQuery(""); navigate(`/profile/${user.user}`);}}
                                    style={homeSearch ? {"marginTop": "0px"} : idPage(v_page.pathname) !== "profile" ? {"marginTop": "0px"} : idProfile(v_page.pathname) === user.user ? {"marginTop": "0px", "backgroundColor": "var(--primary-bg-03)"} : {"marginTop": "0px"}}
                                >
                                <PersonSharp className="large-homePageMainNavigationIcon"
                                    style={homeSearch ? {} : idPage(v_page.pathname) !== "profile" ? {} : idProfile(v_page.pathname) === user.user ? {"color": "var(--secondary-bg-03)"} : {}}
                                />
                        ...
                        <button className="large-homePageMainNavigationIconContainerBtn"
                                onClick={() => {setHomeSearch(false); setHomeSearchQuery(""); navigate("/");}}
                                style={homeSearch ? {"marginTop": "0px"} : idPage(v_page.pathname) === "" || idPage(v_page.pathname) === "post" ? {"marginTop": "0px", "backgroundColor": "var(--primary-bg-03)"} : 
                                    idPage(v_page.pathname) !== "profile" ? {"marginTop": "0px"} : !user ? {"marginTop": "0px", "backgroundColor": "var(--primary-bg-03)"} : idProfile(v_page.pathname) !== user.user ? {"marginTop": "0px", "backgroundColor": "var(--primary-bg-03)"} : {"marginTop": "0px"}
                                }
                            >
                            <Cottage className="large-homePageMainNavigationIcon" 
                                style={homeSearch ? {} : idPage(v_page.pathname) === "" || idPage(v_page.pathname) === "post" ? {"color": "var(--secondary-bg-03)"} : 
                        ...
                        <button className="large-homePageMainNavigationIconContainerBtn"
                                ...
                                style={!homeSearch && idPage(v_page.pathname) === "search" ? {"marginTop": "0px", "backgroundColor": "var(--primary-bg-03)"} : {"marginTop": "0px"}}
                            >
                            <SearchSharp className="large-homePageMainNavigationIcon" 
                                style={!homeSearch &&  idPage(v_page.pathname) === "search" ? {"color": "var(--secondary-bg-03)"} : {}}
                            />
                            <span className="large-homePageMainNavigationIconContainerBtnDesc"
                                    style={!homeSearch &&  idPage(v_page.pathname) === "search" ? {"color": "var(--secondary-bg-03)"} : {}}
                                >
                        ...
                        {user ? 
                            <button className="large-homePageMainNavigationIconContainerBtn"
                                    onClick={() => {setHomeSearch(false); setHomeSearchQuery(""); navigate("/wallet");}}
                                    style={!homeSearch && idPage(v_page.pathname) === "wallet" ? {"marginTop": "0px", "backgroundColor": "var(--primary-bg-03)"} : {"marginTop": "0px"}}
                                >
                                <AccountBalanceWallet className="large-homePageMainNavigationIcon"
                                    style={!homeSearch &&  idPage(v_page.pathname) === "wallet" ? {"color": "var(--secondary-bg-03)"} : {}}
                                />
                                <span className="large-homePageMainNavigationIconContainerBtnDesc"
                                        style={!homeSearch &&  idPage(v_page.pathname) === "wallet" ? {"color": "var(--secondary-bg-03)"} : {}}
                                    >
                        ...
                        <button className="large-homePageMainNavigationIconContainerBtn"
                                onClick={() => {setHomeSearch(false); setHomeSearchQuery(""); navigate("/stocks");}}
                                style={!homeSearch && idPage(v_page.pathname) === "stocks" ? {"marginTop": "0px", "backgroundColor": "var(--primary-bg-03)"} : {"marginTop": "0px"}}
                            >
                            <svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                                <g 
                                        stroke={!homeSearch && idPage(v_page.pathname) === "stocks" ? "var(--secondary-bg-03)" : "#9E9E9E"} 
                            ...
                            <span className="large-homePageMainNavigationIconContainerBtnDesc"
                                    style={!homeSearch &&  idPage(v_page.pathname) === "stocks" ? {"color": "var(--secondary-bg-03)"} : {}}
                                >
                                Stocks
                            </span>
                        </button>
                        <button className="large-homePageMainNavigationIconContainerBtn"
                                onClick={() => {setHomeSearch(false); setHomeSearchQuery(""); navigate("/cryptos");}}
                                style={!homeSearch && idPage(v_page.pathname) === "cryptos" ? {"marginTop": "0px", "backgroundColor": "var(--primary-bg-03)"} : {"marginTop": "0px"}}
                            >
                            <svg viewBox="0 0 22 22"
                                    focusable="false" aria-hidden="true"
                                    style={{"width": "22px", "minWidth": "22px", "maxWidth": "22px", "height": "22px", "minHeight": "22px", "maxHeight": "22px"}}
                                    className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium large-homePageMainNavigationIcon css-1umw9bq-MuiSvgIcon-root" data-testid="NewspaperIcon"
                                >
                                <path d="M11 22C4.975 22 0 17.025 0 11S4.975 0 11 0s11 4.975 11 11-4.975 11-11 11zm3.438-15.222l.557-2.23-1.797-.444-.443 1.78a5.691 5.691 0 00-.894-.22l.444-1.78L10.176 3.3l-.557 2.23c-2.052.371-3.794 1.877-4.317 4.003s.278 4.283 1.833 5.555l-.557 2.23 1.797.444.443-1.78a5.691 5.691 0 00.894.22l-.444 1.78 1.797.443.557-2.23a5.512 5.512 0 003.57-2.328l-1.958-.472a3.715 3.715 0 01-3.534.966c-1.967-.486-3.176-2.45-2.683-4.383s2.473-3.108 4.44-2.622a3.702 3.702 0 012.65 2.517l1.958.472a5.525 5.525 0 00-2.062-3.728z" 
                                    fill={!homeSearch && idPage(v_page.pathname) === "cryptos" ? "var(--secondary-bg-03)" : "#9E9E9E"}
                                />
                            </svg>
                            <span className="large-homePageMainNavigationIconContainerBtnDesc"
                                    style={!homeSearch && idPage(v_page.pathname) === "cryptos" ? {"color": "var(--secondary-bg-03)"} : {}}
                                >
                                Cryptos
                            </span>
                        </button>
                        <button className="large-homePageMainNavigationIconContainerBtn"
                                onClick={() => {setHomeSearch(false); setHomeSearchQuery(""); navigate("/market");}}
                                style={!homeSearch && idPage(v_page.pathname) === "market" ? {"marginTop": "0px", "backgroundColor": "var(--primary-bg-03)"} : {"marginTop": "0px"}}
                            >
                            <AccountBalance className="large-homePageMainNavigationIcon"
                                style={!homeSearch && idPage(v_page.pathname) === "market" ? {"color": "var(--secondary-bg-03)"} : {}}
                            />
                            <span className="large-homePageMainNavigationIconContainerBtnDesc"
                                    style={!homeSearch && idPage(v_page.pathname) === "market" ? {"color": "var(--secondary-bg-03)"} : {}}
                            >
